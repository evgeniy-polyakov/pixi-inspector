import*as PIXI from'pixi.js';class ContextMenu {
...
${hasChildren ? "<span class=\"toggle\"></span>" : ""}
    ...
    getItemName(data, id) {
        ...
        if (texture === null || texture === void 0 ? void 0 : texture.isTexture) {
            ...
            name += `<span>:&nbsp;</span><span data-texture="${id}"><u>${texture === PIXI.Texture.EMPTY ? "Texture.EMPTY" :
...
`;class PixiInspector {
    constructor(root, renderer, style) {
        this._tempRect = new PIXI.Bounds();
        this._enabled = false;
